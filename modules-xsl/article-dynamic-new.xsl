<?xml version="1.0" encoding="UTF-8"?><!-- DWXMLSource="psoriasis.xml" -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xalan" xmlns:java="http://xml.apache.org/xslt/java" xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:fn="http://www.w3.org/TR/2006/PR-xpath-functions-20061121/" exclude-result-prefixes="xsl fn java xalan xalan-nodeset">
	...
	<xsl:variable name="pagination_test"><!-- Only applies the omniture test to articles with the following Chron IDs -->
		<xsl:choose>
			<xsl:when test="$pl_test = '091e9c5e80008bd6' or  $pl_test = '091e9c5e8001da89' or  $pl_test = '091e9c5e8001e141' or  $pl_test = '091e9c5e80009279' or  $pl_test = '091e9c5e801a3b21' or  $pl_test = '091e9c5e80075add'">
	...
	*** All the comments in this XSL surrounded by *** are there for the mobile display format ***
	...
	<xsl:choose>
		...
		<xsl:when test="$pagination_test = 'true'">
					<xsl:call-template name="cons_feature_new_pagination"></xsl:call-template>
				</xsl:when>
				<xsl:otherwise>
				<xsl:element name="div">
					<xsl:choose>
						<xsl:when test="//webmd_rendition/content/wbmd_asset/metadata_section/wbmd_publ/wbmd_publ_name='WebMD Image Collection'">
							<xsl:attribute name="class">article img_collection</xsl:attribute>
						</xsl:when>
						<xsl:otherwise>
	...
	<!--  FEATURE TEMPLATE -->
	<xsl:template name="cons_feature_new_pagination">
